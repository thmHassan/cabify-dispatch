...
const historyData = [
    {
        date: "1/10/2025 - 12:26 PM",
        from: "London Central Railway Station",
        to: "213, Park Avenue Street, Near",
    },
    {
        date: "1/10/2025 - 12:26 PM",
        from: "London Central Railway Station",
...
const History = () => {
    return (
        <div className="w-[420px] bg-white rounded-2xl p-6 max-h-[85vh] overflow-y-auto">
            {/* Header */}
            <h2 className="text-center text-lg font-semibold text-[#111]">
                History
            </h2>
            ...
            {/* Phone Number */}
            <p className="text-center text-xl font-semibold text-[#111] mt-2">
                +1 555 234 6987
            </p>
                ...
                {historyData.map((item, index) => (
                    ...
                    >
                        ...
                        <p className="text-[15px] text-[#252525]">
                            <span className="text-[15px] text-[#252525]">From</span> -{" "}
                            {item.from}
                        </p>

                        <p className="text-[15px] text-[#252525] mt-1">
                            <span className="text-[15px] text-[#252525]">To</span> -{" "}
                            {item.to}
                        </p>
                    </div>
                ))}
